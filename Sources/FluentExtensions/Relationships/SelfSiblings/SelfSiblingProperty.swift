...
public struct SelfSiblingModelMiddleware<Through: Model, M: Model>: ModelMiddleware {
    var from: KeyPath<Through, ParentProperty<Through, M>>
    var to: KeyPath<Through, ParentProperty<Through, M>>

    public func create(model: Through, on db: Database, next: AnyModelResponder) -> EventLoopFuture<Void> {
