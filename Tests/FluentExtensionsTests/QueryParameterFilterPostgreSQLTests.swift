...
class QueryParameterFilterPostgreSQLTests: FluentTestModels.TestCase {
    ...
    func testPostgresStringArrayOperations() async throws {
        ...
        let containsAllStrings = try await getFilteredItems(.field("stringArrayField", "ca", ["value1", "value2"]))
        ...
        let containsAnyStrings = try await getFilteredItems(.field("stringArrayField", "cany", ["value1", "nonexistent"]))
    ...
    func testPostgresIntArrayOperations() async throws {
        ...
        let containsAllInts = try await getFilteredItems(.field("intArrayField", "ca", [1, 2]))
        ...
        // Test empty array
        let emptyIntArray = try await getFilteredItems(.field("intArrayField", "ca", [] as [Int]))
    ...
    func testPostgresBooleanArrayOperations() async throws {
        ...
        let containsAllBools = try await getFilteredItems(.field("booleanArrayField", "ca", [true, false]))
    ...
    func testPostgresEnumArrayOperations() async throws {
        ...
        let containsAllEnums = try await getFilteredItems(.field("stringEnumArray", "ca", [TestStringEnum.case1, TestStringEnum.case2]))
        ...
        let complexEnumArray = try await getFilteredItems(.and([
    ...
    func testPostgresArrayIsContainedBy() async throws {
        ...
        let isContainedBy = try await getFilteredItems(.field("intArrayField", "cb", [1, 2, 3, 4, 5]))
